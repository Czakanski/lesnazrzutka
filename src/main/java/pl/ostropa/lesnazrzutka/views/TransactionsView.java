...
public class TransactionsView extends VerticalLayout {
    ...
    // OPTIMIZATION: Cache static NumberFormat to avoid creating new instances every render
    ...
    /**
     * OPTIMIZATION: Clean up Security Context when view is detached
     * This prevents memory leaks from SecurityContextHolder keeping references
     */
    @Override
    ...
    private VerticalLayout createMainContent() {
        ...
        // OPTIMIZATION: Get grouped transactions only once
        ...
        try {
            ...
            // OPTIMIZATION: Explicitly clear references to help GC
            // (though GC will handle this, explicit is better for memory-critical apps)
    ...
    private VerticalLayout createSummarySection(Map<String, TransactionGroupData> groupedTransactions) {
        ...
        // OPTIMIZATION: Use cached currency format
    ...
    private VerticalLayout createAccountGroup(String accountNumber, TransactionGroupData groupData) {
        ...
        // OPTIMIZATION: Use cached currency format
        String totalAmount = CURRENCY_FORMAT.format(groupData.getTotalAmount());
        ...
        grid.addColumn(Transaction::getToAccountNumber)
                ...
                .setFlexGrow(1);
        grid.addColumn(t -> CURRENCY_FORMAT.format(t.getAmount()))
                .setHeader("Kwota")
                .setFlexGrow(0);
